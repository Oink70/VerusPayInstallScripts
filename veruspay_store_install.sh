...
clear
echo "=========================================================="
echo "|        WELCOME TO THE VERUSPAY STORE INSTALLER!        |"
echo "|                                                        |"
echo "|  This installer is meant for NEW STORES ONLY. If you   |"
...
echo "|                                                        |"
echo "|  This does NOT install Verus Chain Tools.              |"
echo "|                                                        |"
...
#Begin operations
echo ""
echo "Thank you. Beginning store and wordpress server configuration!"
echo ""
...
sudo cat >/etc/apache2/mods-available/dir.conf <<EOL
<IfModule mod_dir.c>
